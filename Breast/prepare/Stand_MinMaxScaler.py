...
input_path = r'C:\Users\Administrator\Desktop\Breast\benign.csv'
output_path = r'C:\Users\Administrator\Desktop\Breast\benign_Stand_MinMaxScaler.csv'
Stand_MinMaxScaler(input_path, output_path)
print('良性数据已完成标准化和归一化。')
input_path = r"C:\Users\Administrator\Desktop\Breast\malignant.csv"
output_path = r'C:\Users\Administrator\Desktop\Breast\malignant_Stand_MinMaxScaler.csv'
Stand_MinMaxScaler(input_path, output_path)
