...
# 指定保存数据的路径和文件名
file_path = r'C:\Users\Administrator\Desktop\Breast\testdata.csv'
...
if __name__ == '__main__':
    ...
    CESMdata2 = CESM(base_dir=r"C:\Users\Administrator\Desktop\Breast\data\test",
    ...
    net = model( in_channels=3,num_classes=2,chunk=3,csv_shape = csv_shape,CSV=False)

    net.to(device)

    path1 = r'E:\pycharmproject\Breast\checkpoint\Resnet50\Tuesday_25_June_2024_19h_45m_56s\Resnet50-64-best.pth'
    ...
    with torch.no_grad():
        for i, x in enumerate(CESM_10_test_l):
            ...
            outputs= net(data_DCE,data_T2,data_T1,csv)
    ...
    data = [
        ...
        ['auc_score', auc_score],
        ['Recall_L', recall_l.numpy()],
        ['Precision_L', precision_l.item()],
        ['Npv_L', npv_l.item()],
        ['ppv_l', ppv_l.item()],
