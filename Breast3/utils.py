...
class ActivationsAndGradients:
    ...
    def __call__(self, data_DCE,data_T2,data_T1,csv):
        self.gradients = []
        self.activations = []
        return self.model(data_DCE,data_T2,data_T1,csv)
...
class GradCAM:
    ...
    def __call__(self, data_DCE,data_T2,data_T1,csv, target_category=None):
        ...
        output = self.activations_and_grads(data_DCE,data_T2,data_T1,csv)
