...
class CustomResNet50(nn.Module):
    def __init__(self,  in_channels=3,num_classes=2, chunk=3,csv_shape = 107,CSV=True):
...
if __name__ == '__main__':
    # 创建一个实例，并指定类别数
    net = CustomResNet50( in_channels=3,num_classes=2,chunk=3,csv_shape = 107,CSV=False)
    # 打印每一层的名称以及其参数是否可训练
    ...
    output = net(data_DCE,data_T2,data_T2,csv)
    print("前连接层特征尺寸:", output.size())