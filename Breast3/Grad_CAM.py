...
def main():
    ...
    net = model1( in_channels=3,num_classes=2,chunk=3,csv_shape = 321,CSV=False)
    ...
    CESMdata2 = CESM(base_dir=r'C:\Users\Administrator\Desktop\临时\CAM',
    ...
    for i, x in enumerate(CESM_10_test_l):
        ...
        grayscale_cam = cam(data_DCE,data_T2,data_T1,csv, target_category=target_category)
...
#         plt.show()
#         #设置保存路径
#         save_path = r"C:\Users\Administrator\Desktop\临时\图片\heatmap.png"
#
#         # 使用Matplotlib保存图像
