...
def main():
    ...
    net = model1( in_channels=3,num_classes=2,chunk=2,csv_shape = 214,CSV=True)
    path1 = r'E:\pycharmproject\Breast\checkpoint\Resnet50\Sunday_23_June_2024_14h_33m_42s\Resnet50-29-best.pth'
    ...
    for i, x in enumerate(CESM_10_test_l):
        ...
        grayscale_cam = cam(data_DCE,data_T2,csv, target_category=target_category)
