...
dcms_root_path = r'C:\Users\Administrator\Desktop\Breast\ki67原始数据\低表达\T2'  # dicom序列文件所在路径
nii_path = r'C:\Users\Administrator\Desktop\Breast\NIIdata\Low\T2'  # 所需.nii.gz文件保存路径
