...
if __name__ == '__main__':
    ...
    CESMdata2 = CESM(base_dir=r"C:\Users\Administrator\Desktop\Breast\验证集",
    ...
    net = model( in_channels=3,num_classes=2, Seq=3,csv_shape = csv_shape,CSV=True)
    ...
    with torch.no_grad():
        for i, x in enumerate(CESM_10_test_l):
            ...
            outputs= net(data_DCE,data_T2,data_T1,data_DWI,csv)
